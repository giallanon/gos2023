#include "gosAssetLoader_tex2D.h"
...
//******************************************************
void Loader_tex2D::unload (Loader *assetLoader, const asset::Context &ctx, const asset::UID &uid, void *ptToAssetData)
{
...
//******************************************************
bool Loader_tex2D::load (Loader *assetLoader, const asset::Context &ctx, const asset::UID &uid, void *in_out_asset)
{
