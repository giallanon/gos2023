#ifndef _gosEngineLoaders_GPUShape_h_
#define _gosEngineLoaders_GPUShape_h_
...
namespace gos
{
    namespace engine
    {
        ...
        {
            //********************************************************
            class Loader_GPUShape : public loaders::BaseLoader
            {
            public:
                eResult load (LoaderInfo &loaderInfo, void *resIN, CallbackData *in_out__callback_data)
                {
					...
					//la GPUShape e i relativi spazi in IB/VB
...
#endif //_gosEngineLoaders_GPUShape_h_
