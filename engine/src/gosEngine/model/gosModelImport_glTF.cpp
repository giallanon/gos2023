...
//********************************************
void glTFImporter::priv_printSkeleton() const
{
	logger::log (eTextColor::green, "===================================================\n");
	logger::log (eTextColor::green, "glTFImporter::print skeleton\n");
	logger::incIndent();
...
void glTFImporter::priv_printSkeleton_rec(const Bone *bone) const
{
	while (NULL != bone)
	{
