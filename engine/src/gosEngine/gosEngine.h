...
namespace gos
{
	...
	public:
		...
		bool            hotreload (ENGVtxShader handle)																{ return res_hotreload (handle.res_handle); }
		...
		bool            hotreload (ENGPxlShader handle)																{ return res_hotreload (handle.res_handle); }
		...
		bool            hotreload (ENGPipeline handle)																{ return res_hotreload (handle.res_handle); }
