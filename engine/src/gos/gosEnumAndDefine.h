...
enum class eGPUDescriptrorType : u8    //sono pari pari ai corrispondenti enum di vulkan
{
    ...
    UNIFORM_BUFFER = 6,         //aka VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER
    STORAGE_BUFFER = 7,         //aka VK_DESCRIPTOR_TYPE_STORAGE_BUFFER
    DYNAMIC_UNIFORM_BUFFER = 8, //aka VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC
    DYNAMIC_STORAGE_BUFFER = 9, //aka VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC
    INPUT_ATTACHMENT = 10,
