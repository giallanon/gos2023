#ifndef _gosCompileTimeHashedString_h_
#define _gosCompileTimeHashedString_h_
#include "../gosEnumAndDefine.h"

//preso da https://stackoverflow.com/questions/2111667/compile-time-string-hashing
