...
//******************************************
bool BufferLinear::append (const void *src, u32 *in_out_offset, u32 nBytesTowrite, bool bCangrow)
{
...
//******************************************
bool BufferLinear::appendStr (const char *s, u32 *in_out_offset, bool bCangrow)
{
