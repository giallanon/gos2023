...
private:
    ...
    void        priv_mesh_buildSingleQuad (f32 spessore, const sInfo *info, const sQuad &quad, u32 firstVtxSRC, VertexList3 &out_vtxList, gos::FastArray<u16> &out_idxList) const;
    ...
    void        priv_mesh_addSpessore (f32 spessore, u32 firstVtx, VertexList3 &out_vtxList, gos::FastArray<u16> &out_idxList) const;
