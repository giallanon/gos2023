...
//*******************************************************
void MarchingSquare::buildMesh (VertexList3 &out_vtxList, gos::FastArray<u16> &out_idxList) const
{
    out_vtxList.reset();
    out_idxList.reset();
...
*/
    ...
    for (u32 i=0; i<getNumPerimetri(); i++)
    {
        ...
        for (u32 i2=0; i2<info->numQuad; i2++)
        {
            ...
            quad.x = info->xPos[i2];
            quad.y = info->yPos[i2];
            priv_mesh_buildSingleQuad (info, quad, firstVtxSRC, out_vtxList, out_idxList);
...
//*******************************************************
void MarchingSquare::priv_mesh_buildSingleQuad (const sInfo *info, const sQuad &quad, u32 firstVtxSRC, VertexList3 &out_vtxList, gos::FastArray<u16> &out_idxList) const
{
    ...
    priv_mesh_addSpessore (firstVtx, out_vtxList, out_idxList);
}

//*******************************************************
void MarchingSquare::priv_mesh_addSpessore (u32 firstVtx, VertexList3 &out_vtxList, gos::FastArray<u16> &out_idxList) const
{
