...
\
    (*out_mat)(0,0) = 1.0f-(fTyy+fTzz);\
    (*out_mat)(1,0) = fTxy-fTwz;\
    (*out_mat)(2,0) = fTxz+fTwy;\
    (*out_mat)(0,1) = fTxy+fTwz;\
    (*out_mat)(1,1) = 1.0f-(fTxx+fTzz);\
    (*out_mat)(2,1) = fTyz-fTwx;\
    (*out_mat)(0,2) = fTxz-fTwy;\
    (*out_mat)(1,2) = fTyz+fTwx;\
    (*out_mat)(2,2) = 1.0f-(fTxx+fTyy);\



#define QUAT_TO_ROT3x3_v2(out_mat)\
    const f32 fTx  = 2.0f*x;\
    const f32 fTy  = 2.0f*y;\
    const f32 fTz  = 2.0f*z;\
    const f32 fTwx = fTx*w;\
