...
//************************************
void Builder_model3d::priv_reset_parsed_params()
{
...
//************************************
bool Builder_model3d::priv_extractParams (DBContext &ctx, const UniqueUIDList &listof_UID_of_known_ini_file, const char *absFilename)
{
    //setto i default
    priv_reset_parsed_params();
